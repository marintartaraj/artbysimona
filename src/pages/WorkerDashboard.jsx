...
import { Calendar, Clock, LogOut, Shield, Users, CheckCircle, AlertCircle, Phone, Mail, ArrowRight, TrendingUp } from 'lucide-react';
              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="inline-flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20">
                    ...
                    <span className="text-xs sm:text-sm font-medium text-emerald-100">Worker Panel</span>
                  </div>
                </div>
              ...
              <Card className="bg-gradient-to-br from-emerald-900/60 to-emerald-800/60 backdrop-blur-xl border border-emerald-800/30 rounded-2xl">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm sm:text-base text-emerald-300 font-medium">My Bookings</p>
                  ...
                  <div className="space-y-4">
                    {bookings.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-emerald-200">No bookings assigned yet.</p>
                      </div>
                    ) : (
                  ...
                  <div className="space-y-6">
                    <div className="text-center py-8">
                      <div className="inline-flex items-center gap-2 px-3 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-4">
                        ...
                        <span className="text-sm font-medium text-emerald-100">Schedule Management</span>
                      </div>
                      <p className="text-emerald-200 mb-6">View and manage your daily schedule</p>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-3 bg-emerald-800/30 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm text-emerald-200">Available</span>
                        </div>
                        <span className="text-xs text-emerald-300">9:00 AM - 6:00 PM</span>
                      </div>
                      
                      <div className="flex items-center justify-between p-3 bg-emerald-800/30 rounded-lg">
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                          <span className="text-sm text-emerald-200">Booked</span>
                        </div>
                        <span className="text-xs text-emerald-300">2 appointments</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
